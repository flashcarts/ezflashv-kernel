...
CODE_IN_ITCM void mpeg2_idct_copy_cfast_noclip(int16_t * block, uint8_t * dest, const int stride)
{
    int idx;
...
CODE_IN_ITCM void mpeg2_idct_add_c_noclip(const int last, int16_t * block, uint8_t * dest, const int stride)
{
    int i;
