...
@-----------------viod scms_sd_data_write_s(u16 *buff,u16* crc16buff)-------------------
    .ALIGN
    .GLOBAL scms_sd_data_write_s	
    .CODE 32
scms_sd_data_write_s:
	stmfd   r13!,{r4-r5}
	mov	r5,#512
	mov	r2,#sd_dataadd
sd_data_write_busy:
...
sd_data_write_loop2:
	...
	ldmfd	r13!,{r4-r5}
	bx      r14
@-----------------end scms_sd_data_write_s-------------------

@----------void scms_sd_data_read_s(u16 *buff)-------------
    .ALIGN
    .GLOBAL scms_sd_data_read_s	
    .CODE 32
scms_sd_data_read_s:
	stmfd   r13!,{r4}
	mov	r1,#sd_dataradd
...
@--------------u8 scms_sd_crc7_s(u16* buff,u16 num)----------------------------
    .ALIGN
    .GLOBAL	scms_sd_crc7_s 
    .CODE 32
scms_sd_crc7_s:
	stmfd   r13!,{r4}
...
@--------------scms_sd_com_read_s(u16* buff,u32 num)------------------
		.ALIGN
		.GLOBAL	 scms_sd_com_read_s 
		.CODE 32
...
sd_com_read_loop:
	...
	ldmfd	r13!,{r4-r6}
	bx      r14
@--------------end scms_sd_com_read_s------------------

@-------------------void scms_sd_com_write_s(u16* buff,u32 num)-----------------

		.ALIGN
		.GLOBAL	 scms_sd_com_write_s
		.CODE 32
scms_sd_com_write_s:
	stmfd   r13!,{r4-r6}
...
@	*char2++=*char1--;
@	*char2++=*char1;
@	*char2=scms_sd_crc7_s((u32)databuff,5);
@
@	scms_sd_com_write_s((u32)databuff,6);
@
@}
scms_SDCommand:
	stmfd   r13!,{r14}
...
@	for (j=0;j<i ; j++)
@	{
@		scms_sd_data_read_s((u32)buff+j*512);
@	}
...
@ microsd
stmdb	sp!, {r0, r2, r4, r5, r6, lr}

ldmia	sp!, {r4, r5}
bl	scms_MemoryCard_IsInserted
...
@	for (j=0;j<i ; j++)
@	{
@		scms_sd_crc16_s((u32)(u32)buff+j*512,512,(u32)crc16);
@		scms_sd_data_write_s((u32)buff+j*512,(u32)crc16);
@		scms_send_clk(0x10); 
@	}
@	scms_SDCommand(12,0,0); 
@	scms_get_resp();
