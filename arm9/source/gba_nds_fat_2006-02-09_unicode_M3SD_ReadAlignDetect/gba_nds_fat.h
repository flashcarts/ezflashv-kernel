...
// FAT16 Cache Enabled.
// Request disabled CAN_WRITE_TO_DISC
//#define UseFatDump
...
u32 GetSecPerCls();
u32 GetFisrtCls();
u32 fat_copyfat(const char* filename,unsigned char* pdes);
u32 FAT_NextCluster(u32 cluster);
u32 fat_GetLastCluster();
//-----------------------------------------------------------------
// CF Card functions
...
// change point findstr 'lfnNameUnicode'
...
extern bool FAT_GetLongFilenameUnicode (Tunicode* filename,int MaxCount);
