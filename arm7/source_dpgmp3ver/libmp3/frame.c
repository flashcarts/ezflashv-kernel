...
*/
  ...
  {
    // Layer III only
    unsigned long const bitrate_table[15] = { 0,  32000,  40000,  48000,  56000,  64000,  80000,  96000, 112000, 128000, 160000, 192000, 224000, 256000, 320000};
    header->bitrate = bitrate_table[index];
  }
