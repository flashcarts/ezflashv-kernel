...
bool StartMP3(void){};
void FlashFileBufferMP3(void){};
u32 UpdateMP3(s16 *lbuf,s16 *rbuf,bool flash){return(0);};
void FreeMP3(void){};

u32 MP3_GetChannelCount(void){return(0);};
u32 MP3_GetSampleRate(void){return(0);};
u32 MP3_GetSamplePerFrame(void){return(0);};
